/* Some defines */
#define PATH_MAX_                                                                      \
  513 /**< Maximum amount of coordinates that can be stored                            \
...
struct data {
  ...
  double path[PATH_MAX_]
             [2]; /**< When a pathcalculation is made, all coordinates are stored in here.
                                                       [PATH_MAX_-1][0] is used to store the amount of coordinates
                     stored and [PATH_MAX_-1][1] contains the current coordinate the bot is heading towards */
