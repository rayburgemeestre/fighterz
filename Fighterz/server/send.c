...
void send_background(struct data *client, int df_id, int pos_x, int pos_y, char *datfile) {
  char *p = packet;
  unsigned short len = 0;
...
void send_accel(struct data *client, struct data *except, ID id, double x, double y, signed char accel, double speed) {
  char *p = packet;
  unsigned short len = 0;
...
void send_turn(struct data *client, struct data *except, ID id, double x, double y, signed char turn, double deg) {
  char *p = packet;
  unsigned short len = 0;
...
void send_invincible(struct data *client, struct data *except, ID id, unsigned char yesno, unsigned int t) {
  char *p = packet;
  unsigned short len = 0;
...
void send_hit(struct data *client, struct data *except, ID victimid, ID evilid, unsigned char newpower) {
  char *p = packet;
  unsigned short len = 0;
...
void send_newuser(struct data *client,
                  struct data *except,
                  ID id,
                  double x,
                  double y,
...
void send_kill(struct data *client, struct data *except, ID victimid, ID evilid, char *killstr) {
  char *p = packet;
  unsigned short len = 0;
...
void send_newbullet(struct data *client, struct data *except, ID id, ID ownerid, double x, double y, double deg) {
  char *p = packet;
  unsigned short len = 0;
...
void send_spawn(struct data *client,
                struct data *except,
                ID id,
                double x,
                double y,
